...
var _horizontal_size = abs(_max_position[0] - _min_position[0])
var _vertical_size = abs(_max_position[1] - _min_position[1])

//scroll_x = clamp(scroll_x, _min_position[0], _horizontal_size - _min_position[0])
scroll_y = clamp(scroll_y, -_vertical_size + get_render_height(), 0)
